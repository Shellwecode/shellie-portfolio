...
2023). The work centered on the two moments that make or break the app:
how people prompt, and what they get back.
...
Our target users had minimal generative-AI experience and cared about one
thing: results that matched their conception of attractiveness. We used
download likelihood as the satisfaction metric — if you'd keep it, it worked.
...
creative freedom. Instead of staring at an empty text box, users compose from
labels that are known to work. Less typing, lower cognitive load, faster to a
good image.
