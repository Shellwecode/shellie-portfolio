...
trackNotes:
  overview: "Born from the agent builder — iteration outran research"
...
This tool actually came out of *Voice AI Agents*. While designing it, we iterated so
...
<figure>
  <video
    ...
    poster="/video/synthetic-ux-poster.jpg"
    controls
    muted
    playsinline
    preload="auto"
...
For the agent builder, we calibrated five archetypes along two axes: technical
